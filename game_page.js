...
function send(){
    ...
    chartAt2 = word.toString().chartAt(length_divide2);
    console.log(chartAt2);

    length_minus_1 = word.length - 1;
    chartAt3 = word.toString().chartAt(length_minus_1);
...
function check() {
    ...
    if (answer_turn = "player1") {
        ...
        answer_turn = "player1";
        document.getElementById("playr_answer").innerHTML = "Answer turn : " + player1_name;
    }
